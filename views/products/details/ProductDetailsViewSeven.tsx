...
import { ProductImageGallery, Button, RatingStars, ColorSwatch, QuantitySelector, ProductDeliveryInfo, ProductSpecifications, Breadcrumb, ProductDetailsSkeleton, WishlistButton, Tab } from "@/components"
...
import { SimilarProduct, ProductReviews, CustomerReviews, Description, ReturnPolicy, ShippingReturn } from "./sections";
...
const ProductDetailsViewSeven = ({ productId }: { productId: string }) => {
    ...
    return (
        <>
            ...
            {isLoading ? (
                ...
                <ProductDetailsSkeleton showReviews={false} />
                ...
                <>
                    ...
                    <div className="section-lg container space-y-12">
                        ...
                        {/* ================= CUSTOMER REVIEWS / DESCRIPTION / RETURN / SHIPPING ================= */}
                                ...
                                items={[
                                    {
                                        ...
                                        content: <CustomerReviews productId={productId} productRating={product.rating} />
                                    },
                                    {
                                        id: "description",
                                        label: "Description",
...
export default memo(ProductDetailsViewSeven)