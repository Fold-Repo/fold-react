    ...
    return (
        <div className="theme-toggle">
            ...
            <div className="theme-toggle-container">
                ...
                {/* System */}
                <label className="theme-toggle-option cursor-pointer" title="System">
                    <input
                        type="radio"
                        name="theme"
                        value="system"
                ...
                {/* Light */}
                <label className="theme-toggle-option cursor-pointer" title="Light">
                    <input
                        type="radio"
                        hidden
                        name="theme"
                ...
                {/* Dark */}
                <label className="theme-toggle-option cursor-pointer" title="Dark">
                    <input
                        type="radio"
                        hidden
                        name="theme"
